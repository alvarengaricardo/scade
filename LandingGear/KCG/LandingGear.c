...
void LandingGear(inC_LandingGear *inC, outC_LandingGear *outC)
{
  ...
  _L5_Switch_1 = !outC->_L3_Switch_1;
  /* _L5= */
  ...
  switch (outC->SM1_state_nxt) {
    ...
    case SSM_st_DOWN_SM1 :
      SM1_reset_act = outC->_L3_Switch_1;
      if (outC->_L3_Switch_1) {
        SM1_state_act = SSM_st_TRANSITION_SM1;
  ...
  switch (SM1_state_act) {
    ...
    case SSM_st_TRANSITION_SM1 :
      ...
      _L3_TRANSITION_SM1 = outC->_L2_TRANSITION_SM1 >= kcg_lit_int32(10);
      /* SM1:TRANSITION: */
      if (TRANSITION_weakb_clock_SM1) {
        ...
        if (_L3_TRANSITION_SM1) {
          tmp = outC->_L3_Switch_1;
        }
        else {
          tmp = kcg_false;
        }
      ...
      if (outC->_L3_Switch_2) {
        outC->RightSquareFillColor = RED;
        outC->RightTextColorIndex = WHITE;
        kcg_copy_T_String(&outC->RightTextString, (T_String *) &LG_EMPTY_TEXT);
      }
      else {
        outC->RightSquareFillColor = AMBAR;
        outC->RightTextColorIndex = WHITE;
  ...
  /* @1/_L3= */
  if (inC->LG_UpBtn) {
    outC->_L3_Switch_1 = _L5_Switch_1;
  }
  /* _L1= */
  if (outC->_L3_Switch_2) {
  ...
  /* @2/_L3= */
  if (inC->LG_Fail_Btn) {
    outC->_L3_Switch_2 = !outC->_L3_Switch_2;
  }
  outC->Layer1Visible = outC->_L12;
  outC->Layer1Active = outC->_L12;
  outC->_L12 = kcg_true;
