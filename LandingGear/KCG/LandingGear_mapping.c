...
const MappingEntry scope_1_entries[22] = {
    ...
    /* 20 */ { MAP_EXPANDED, "Switch 1", NULL, 0, 0, NULL, NULL, NULL, NULL, 1, 20 },
    /* 21 */ { MAP_EXPANDED, "Switch 2", NULL, 0, 0, NULL, NULL, NULL, NULL, 1, 21 }
};
