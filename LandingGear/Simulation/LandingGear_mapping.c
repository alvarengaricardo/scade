...
const MappingEntry scope_16_entries[2] = {
    ...
    /* 1 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L4_then_IfBlock1_TRANSITION_SM1, &_Type_kcg_bool_Utils, &scope_14_entries[0], isActive_kcg_bool_kcg_true, NULL, 1, 1 }
};
...
const MappingEntry scope_11_entries[10] = {
    ...
    /* 3 */ { MAP_LOCAL, "_L2", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L2_TRANSITION_SM1, &_Type_kcg_int32_Utils, &scope_5_entries[0], isActive_SSM_ST_SM1_SSM_st_TRANSITION_SM1, NULL, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L3_TRANSITION_SM1, &_Type_kcg_bool_Utils, &scope_5_entries[0], isActive_SSM_ST_SM1_SSM_st_TRANSITION_SM1, NULL, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L5_TRANSITION_SM1, &_Type_kcg_int32_Utils, &scope_5_entries[0], isActive_SSM_ST_SM1_SSM_st_TRANSITION_SM1, NULL, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L6", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L6_TRANSITION_SM1, &_Type_kcg_int32_Utils, &scope_5_entries[0], isActive_SSM_ST_SM1_SSM_st_TRANSITION_SM1, NULL, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L7", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L7_TRANSITION_SM1, &_Type_kcg_int32_Utils, &scope_5_entries[0], isActive_SSM_ST_SM1_SSM_st_TRANSITION_SM1, NULL, 1, 7 },
...
const MappingEntry scope_9_entries[4] = {
    /* 0 */ { MAP_LOCAL, "_L9", NULL, sizeof(kcg_uint8), (size_t)&outputs_ctx._L9_else_IfBlock2_DOWN_SM1, &_Type_kcg_uint8_Utils, &scope_8_entries[0], isActive_kcg_bool_kcg_false, NULL, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L8", NULL, sizeof(kcg_uint8), (size_t)&outputs_ctx._L8_else_IfBlock2_DOWN_SM1, &_Type_kcg_uint8_Utils, &scope_8_entries[0], isActive_kcg_bool_kcg_false, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L7", NULL, sizeof(kcg_uint8), (size_t)&outputs_ctx._L7_else_IfBlock2_DOWN_SM1, &_Type_kcg_uint8_Utils, &scope_8_entries[0], isActive_kcg_bool_kcg_false, NULL, 1, 2 },
    /* 3 */ { MAP_LOCAL, "_L6", NULL, sizeof(T_String), (size_t)&outputs_ctx._L6_else_IfBlock2_DOWN_SM1, &_Type_T_String_Utils, &scope_8_entries[0], isActive_kcg_bool_kcg_false, &scope_2, 1, 3 }
};
...
const MappingEntry scope_6_entries[3] = {
    ...
    /* 1 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L3_DOWN_SM1, &_Type_kcg_bool_Utils, &scope_5_entries[0], isActive_SSM_ST_SM1_SSM_st_DOWN_SM1, NULL, 1, 1 },
...
const MappingEntry scope_4_entries[5] = {
    ...
    /* 4 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L5_Switch_2, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 4 }
};
...
const MappingEntry scope_3_entries[5] = {
    ...
    /* 4 */ { MAP_LOCAL, "_L5", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L5_Switch_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 4 }
};
...
const MappingEntry scope_1_entries[41] = {
    ...
    /* 19 */ { MAP_INPUT, "LG_Fail_Btn", NULL, sizeof(kcg_bool), (size_t)&inputs_ctx.LG_Fail_Btn, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 19 },
    ...
    /* 24 */ { MAP_LOCAL, "_L1", NULL, sizeof(T_String), (size_t)&outputs_ctx._L1, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 24 },
    /* 25 */ { MAP_LOCAL, "_L5", NULL, sizeof(T_String), (size_t)&outputs_ctx._L5, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 25 },
    /* 26 */ { MAP_LOCAL, "_L6", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L6, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 26 },
    /* 27 */ { MAP_LOCAL, "_L7", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L7, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 27 },
    /* 28 */ { MAP_LOCAL, "_L8", NULL, sizeof(T_String), (size_t)&outputs_ctx._L8, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 28 },
    /* 29 */ { MAP_LOCAL, "_L9", NULL, sizeof(T_String), (size_t)&outputs_ctx._L9, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 29 },
    /* 30 */ { MAP_LOCAL, "_L10", NULL, sizeof(kcg_uint16), (size_t)&outputs_ctx._L10, &_Type_kcg_uint16_Utils, NULL, NULL, NULL, 1, 30 },
    /* 31 */ { MAP_LOCAL, "_L11", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L11, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 31 },
    /* 32 */ { MAP_LOCAL, "_L12", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L12, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 32 },
    /* 33 */ { MAP_LOCAL, "_L13", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L13, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 33 },
    /* 34 */ { MAP_LOCAL, "_L14", NULL, sizeof(T_String), (size_t)&outputs_ctx._L14, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 34 },
    /* 35 */ { MAP_LOCAL, "_L15", NULL, sizeof(T_String), (size_t)&outputs_ctx._L15, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 35 },
    /* 36 */ { MAP_LOCAL, "_L21", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L21, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 36 },
    /* 37 */ { MAP_LOCAL, "_L23", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L23, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 37 },
