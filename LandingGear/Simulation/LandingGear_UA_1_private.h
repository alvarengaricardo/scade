 ...
 *********************************************************/
#ifndef _LANDINGGEAR_UA_1_PRIVATE_H_
#define _LANDINGGEAR_UA_1_PRIVATE_H_ 
...
uaa_size a661_com_csp_widget_PushButton(buffer_el msg[], uaa_uint16 wid, uaa_bool A661_STRING__emit__, unsigned innerdim_A661_STRING_LabelString_, unsigned char * A661_STRING_LabelString_, kcg_uint16 A661_STRING_String_size_);
uaa_size a661_com_csp_widget_Label(buffer_el msg[], uaa_uint16 wid, uaa_bool A661_COLOR_INDEX__emit__, kcg_uint8 A661_COLOR_INDEX_ColorIndex_, uaa_bool A661_STRING__emit__, unsigned innerdim_A661_STRING_LabelString_, unsigned char * A661_STRING_LabelString_, kcg_uint16 A661_STRING_String_size_);
uaa_size a661_com_csp_widget_GpRectangle(buffer_el msg[], uaa_uint16 wid, uaa_bool A661_COLOR_INDEX__emit__, kcg_uint8 A661_COLOR_INDEX_ColorIndex_, uaa_bool A661_FILL_INDEX__emit__, kcg_uint8 A661_FILL_INDEX_FillIndex_);

/* Functions to pack messages for layers */
uaa_size a661_com_layer_1(buffer_el msg[], outC_LandingGear* scade_ctx,  extern_out_ctx_t* extern_ctx);
#endif /* _LANDINGGEAR_UA_1_PRIVATE_H_ */

/*********************************************************
 ** End of file
 ** End of generation: 2018-10-10T00:49:49
 *********************************************************/
