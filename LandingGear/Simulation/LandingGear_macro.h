...
#define VARC_LandingGear_LG_Fail_Btn(context) context.inputs_ctx.LG_Fail_Btn  /* LandingGear/LG_Fail_Btn */
#define VAR_LandingGear_LG_Fail_Btn VARC_LandingGear_LG_Fail_Btn(CTX_LandingGear)
...
#define T_LG_Fail_Btn kcg_bool
#define CPY_LG_Fail_Btn(DST, SRC) DST = SRC
