 ...
 ********************************************************************************************/
 uaa_size LandingGear_UA_1_send(buffer_el msg[], 
 ...
 ********************************************************************************************/
uaa_size LandingGear_UA_1_receive(buffer_el buffer[],  uaa_size buffer_size, 
  inC_LandingGear* scade_ctx,  extern_in_ctx_t * extern_ctx){
                  ...
                  case 5 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_SELECTION : 
                        ...
                        /*  Notify */
                        scade_ctx->LG_Fail_Btn = kcg_true;
                        break;
                      default : break;
                    }
                    n = next_n;
 ...
 * Clear notifications                                                                      *
 ********************************************************************************************/
void LandingGear_UA_1_receive_clear(inC_LandingGear* scade_ctx, 
  extern_in_ctx_t * extern_ctx){
  scade_ctx->LG_UpBtn = kcg_false;
  scade_ctx->LG_Fail_Btn = kcg_false;
}
