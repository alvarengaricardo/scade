...
** Generation date: 2018-10-10T01:19:21
*************************************************************$ */
...
void LandingGear(inC_LandingGear *inC, outC_LandingGear *outC)
{
  ...
  outC->_L5_Switch_1 = !outC->_L2_Switch_1;
  outC->_L6 = inC->LG_UpBtn;
  outC->Input1_Switch_1 = outC->_L6;
  outC->_L1_Switch_1 = outC->Input1_Switch_1;
  /* @1/_L3= */
  if (outC->_L1_Switch_1) {
    outC->_L3_Switch_1 = outC->_L5_Switch_1;
  }
  else {
  ...
  outC->_L5_Switch_2 = !outC->_L2_Switch_2;
  outC->_L13 = inC->LG_Fail_Btn;
  outC->Input1_Switch_2 = outC->_L13;
  outC->_L1_Switch_2 = outC->Input1_Switch_2;
  /* @2/_L3= */
  if (outC->_L1_Switch_2) {
    outC->_L3_Switch_2 = outC->_L5_Switch_2;
  }
  else {
    outC->_L3_Switch_2 = outC->_L2_Switch_2;
  }
  outC->Output1_Switch_2 = outC->_L2_Switch_2;
  outC->SM1_state_sel = outC->SM1_state_nxt;
  outC->_L21 = outC->Output1_Switch_1;
  outC->LG_Up = outC->_L21;
  /* SM1: */
  ...
  outC->_L23 = outC->Output1_Switch_2;
  outC->LG_Fail = outC->_L23;
  switch (outC->SM1_state_act) {
    case SSM_st_UP_SM1 :
      ...
      if (outC->IfBlock2_clock_UP_SM1) {
        ...
        kcg_copy_T_String(&outC->_L1_then_IfBlock2_UP_SM1, (T_String *) &LG_UP_TEXT);
        kcg_copy_T_String(
    ...
    case SSM_st_TRANSITION_SM1 :
      outC->TRANSITION_weakb_clock_SM1 = outC->SM1_fired_strong !=
        SSM_TR_no_trans_SM1;
      outC->_L7_TRANSITION_SM1 = kcg_lit_int32(10);
      break;
    default :
      /* this branch is empty */
      break;
  ...
  switch (outC->SM1_state_act) {
    ...
    case SSM_st_TRANSITION_SM1 :
      ...
      if (outC->init1) {
        ...
        outC->_L5_TRANSITION_SM1 = outC->_L2_TRANSITION_SM1;
      }
      outC->_L6_TRANSITION_SM1 = kcg_lit_int32(1);
      outC->_L2_TRANSITION_SM1 = outC->_L5_TRANSITION_SM1 + outC->_L6_TRANSITION_SM1;
      outC->_L3_TRANSITION_SM1 = outC->_L2_TRANSITION_SM1 >= outC->_L7_TRANSITION_SM1;
      ...
      if (outC->IfBlock1_clock_TRANSITION_SM1) {
        ...
        outC->_L4_then_IfBlock1_TRANSITION_SM1 =
          !outC->_L1_then_IfBlock1_TRANSITION_SM1;
        _45_Tr2Dn_partial = outC->_L4_then_IfBlock1_TRANSITION_SM1;
      ...
      if (outC->IfBlock2_clock_TRANSITION_SM1) {
        ...
        _56_LeftSquareBorderColor_partial = outC->_L9_else_IfBlock2_TRANSITION_SM1;
    ...
    case SSM_st_DOWN_SM1 :
      ...
      if (outC->IfBlock2_clock_DOWN_SM1) {
        ...
        outC->_L8_else_IfBlock2_DOWN_SM1 = AMBAR;
        _9_NoseSquareFillColor_partial = outC->_L8_else_IfBlock2_DOWN_SM1;
        kcg_copy_T_String(
          &outC->_L6_else_IfBlock2_DOWN_SM1,
          (T_String *) &LG_DOWN_TEXT);
        kcg_copy_T_String(
          &_1_RightTextString_partial,
          &outC->_L6_else_IfBlock2_DOWN_SM1);
        outC->_L9_else_IfBlock2_DOWN_SM1 = AMBAR;
        _12_NoseSquareBorderColor_partial = outC->_L9_else_IfBlock2_DOWN_SM1;
        _7_RightSquareFillColor_partial = outC->_L8_else_IfBlock2_DOWN_SM1;
        kcg_copy_T_String(
          &_3_NoseTextString_partial,
          &outC->_L6_else_IfBlock2_DOWN_SM1);
        outC->_L7_else_IfBlock2_DOWN_SM1 = WHITE;
        _4_RightTextColorIndex_partial = outC->_L7_else_IfBlock2_DOWN_SM1;
        _6_NoseTextColorIndex_partial = outC->_L7_else_IfBlock2_DOWN_SM1;
        _11_LeftSquareBorderColor_partial = outC->_L9_else_IfBlock2_DOWN_SM1;
        _10_RightSquareBorderColor_partial = outC->_L9_else_IfBlock2_DOWN_SM1;
        kcg_copy_T_String(
          &_2_LeftTextString_partial,
          &outC->_L6_else_IfBlock2_DOWN_SM1);
        _5_LeftTextColorIndex_partial = outC->_L7_else_IfBlock2_DOWN_SM1;
        _8_LeftSquareFillColor_partial = outC->_L8_else_IfBlock2_DOWN_SM1;
      ...
      outC->_L3_DOWN_SM1 = kcg_false;
      Tr2Up_partial = outC->_L3_DOWN_SM1;
      Tr2Dn_partial = outC->_L3_DOWN_SM1;
  ...
  kcg_copy_T_String(&outC->_L15, (T_String *) &LG_BTN_FAIL_TEXT);
  kcg_copy_T_String(&outC->_L14, (T_String *) &LG_BTN_NORM_TEXT);
  /* _L1= */
  if (outC->_L23) {
    kcg_copy_T_String(&outC->_L1, &outC->_L14);
  }
  else {
    kcg_copy_T_String(&outC->_L1, &outC->_L15);
  }
  kcg_copy_T_String(&outC->LG_FailBtnTextString, &outC->_L1);
  /* _L7= */
  if (outC->init) {
    outC->_L7 = kcg_true;
  }
  ...
  outC->_L10 = STR_SIZE;
  kcg_copy_T_String(&outC->_L9, (T_String *) &LG_UP_TEXT);
  kcg_copy_T_String(&outC->_L8, (T_String *) &LG_DOWN_TEXT);
  /* _L5= */
  if (outC->_L21) {
    kcg_copy_T_String(&outC->_L5, &outC->_L8);
  }
  else {
    kcg_copy_T_String(&outC->_L5, &outC->_L9);
  }
  kcg_copy_T_String(&outC->LG_UpBtnTextString, &outC->_L5);
  outC->StringSize = outC->_L10;
  switch (outC->SM1_state_act) {
    case SSM_st_TRANSITION_SM1 :
...
void LandingGear_init(outC_LandingGear *outC)
{
  ...
  outC->_L9_else_IfBlock2_TRANSITION_SM1 = kcg_lit_uint8(0);
  outC->_L4_then_IfBlock1_TRANSITION_SM1 = kcg_true;
  ...
  for (idx11 = 0; idx11 < 5; idx11++) {
    outC->_L6_else_IfBlock2_DOWN_SM1[idx11] = ' ';
  }
  outC->_L7_else_IfBlock2_DOWN_SM1 = kcg_lit_uint8(0);
  outC->_L8_else_IfBlock2_DOWN_SM1 = kcg_lit_uint8(0);
  outC->_L9_else_IfBlock2_DOWN_SM1 = kcg_lit_uint8(0);
  outC->IfBlock2_clock_DOWN_SM1 = kcg_true;
  outC->_L3_DOWN_SM1 = kcg_true;
  outC->_L1_Switch_2 = kcg_true;
  outC->_L2_Switch_2 = kcg_true;
  outC->_L5_Switch_2 = kcg_true;
  outC->Input1_Switch_2 = kcg_true;
  outC->Output1_Switch_2 = kcg_true;
  outC->_L1_Switch_1 = kcg_true;
  outC->_L2_Switch_1 = kcg_true;
  outC->_L5_Switch_1 = kcg_true;
