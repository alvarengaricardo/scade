...
typedef enum kcg_tag_SSM_TR_SM1 {
  SSM_TR_no_trans_SM1,
  SSM_TR_DOWN_TRANSITION_1_DOWN_SM1,
  SSM_TR_TRANSITION_UP_1_TRANSITION_SM1,
  SSM_TR_TRANSITION_DOWN_2_TRANSITION_SM1,
  SSM_TR_UP_TRANSITION_1_UP_SM1
} SSM_TR_SM1;
/* LandingGear/SM1: */
typedef enum kcg_tag_SSM_ST_SM1 {
  SSM_st_DOWN_SM1,
  SSM_st_TRANSITION_SM1,
  SSM_st_UP_SM1
} SSM_ST_SM1;
/* T_String/ */
typedef kcg_char T_String[5];

#ifndef kcg_copy_T_String
#define kcg_copy_T_String(kcg_C1, kcg_C2)                                     \
  (kcg_assign_array((kcg_C1), (kcg_C2), sizeof (T_String)))
