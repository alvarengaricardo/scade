/*********************************************************
 **
 ** File  LandingGear_UA_1_private.c
 **
...
/* Widget Label for parameter A661_COLOR_INDEX */
 uaa_size a661_com_msg_char(buffer_el msg[], 
  uaa_uint16 pid,  kcg_uint8 A661_FILL_INDEX_FillIndex_){
...
/* Widget PushButton for parameter A661_STRING */
...
/* Pack messages for widget PushButton: A661_STRING */
...
/* Pack messages for widget Label: A661_COLOR_INDEX, A661_STRING */
 uaa_size a661_com_csp_widget_Label(buffer_el msg[], 
  uaa_uint16 wid,  uaa_bool A661_COLOR_INDEX__emit__, 
  kcg_uint8 A661_COLOR_INDEX_ColorIndex_,  uaa_bool A661_STRING__emit__, 
  unsigned innerdim_A661_STRING_LabelString_, 
  unsigned char * A661_STRING_LabelString_, 
  kcg_uint16 A661_STRING_String_size_){
  uaa_size offset = 0;
...
/* Pack messages for widget GpRectangle: A661_COLOR_INDEX, A661_FILL_INDEX */
 uaa_size a661_com_csp_widget_GpRectangle(buffer_el msg[], 
  ...
  kcg_uint8 A661_FILL_INDEX_FillIndex_){
  uaa_size offset = 0;
