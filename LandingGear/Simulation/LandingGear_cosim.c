...
void AfterSimInit(void){
	...
	#endif
	pszBinListFiles[0] = "D:/gd/ITA/CE-235/scade/landing_gear/LandingGear/Simulation/LandingGear_UA_1_binaries.txt";
	pszBinListFiles[1] = 0;
	if (0/*OK*/ != A661ConnectServer("127.0.0.1", 1231, pszBinListFiles, "D:/gd/ITA/CE-235/scade/landing_gear/LandingGear/Simulation/LandingGear_UA_1_conf.xml" )) {
		const char *pszError;
